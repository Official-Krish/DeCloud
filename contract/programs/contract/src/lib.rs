...
pub mod contract {
    ...
    pub fn transfer_to_vault_and_rent(
        ...
        instructions::transfer_to_vault_and_rent(ctx, amount, duration_seconds, id)
    }

    pub fn transfer_from_vault(ctx: Context<TransferFromVault>, amount: u64, id: u64) -> Result<()> {
        instructions::transfer_from_vault(ctx, amount, id)
    }
