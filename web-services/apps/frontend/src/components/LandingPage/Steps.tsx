    ...
    <div className="items-center py-20 border-b border-neutral-200 dark:border-neutral-800 ">
        ...
        >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Become a DePIN Node Operator
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Join the decentralized cloud revolution by hosting virtual machines on your hardware. 
            </p>
        </motion.div>
        
        <div className="flex justify-center items-center">
            <CardSpotlight className="h-120 w-100">
            <span className="text-xs font-medium bg-neutral-800 text-white rounded px-2 py-2">Coming Soon</span>
