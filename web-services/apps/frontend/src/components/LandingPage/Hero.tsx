...
export function Hero() {
  ...
  return (
    <motion.div
      className="relative min-h-screen flex items-center justify-center overflow-hidden dark:bg-neutral-950 border-b border-neutral-200 dark:border-neutral-800 bg-neutral-100"
    ...
    >
      ...
      {/* Floating elements */}
      <motion.div
        className="absolute top-20 left-10 w-72 h-48 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-3xl blur-3xl"
        animate={{ scale: [1, 1.1, 1], opacity: [0.8, 1, 0.8] }}
        transition={{ duration: 3, repeat: Infinity }}
      />
      <motion.div
        className="absolute bottom-20 right-10 w-96 h-64 bg-gradient-to-br from-accent/20 to-muted/20 rounded-3xl blur-3xl"
        animate={{ scale: [1, 1.1, 1], opacity: [0.8, 1, 0.8] }}
